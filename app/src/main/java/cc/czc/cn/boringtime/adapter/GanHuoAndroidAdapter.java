...
public class GanHuoAndroidAdapter extends RecyclerView.Adapter<GanHuoAndroidAdapter.MyViewHolder> {
    String TAG = "GanHuoAndroidAdapter";
    List<GanHuoAndroidBean.ResultsBean> data;
    LayoutInflater layoutInflater;
    Context context;
    public GanHuoAndroidAdapter(Context context,List<GanHuoAndroidBean.ResultsBean> data){
        this.data=data;
