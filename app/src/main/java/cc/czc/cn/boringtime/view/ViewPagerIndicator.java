...
public class ViewPagerIndicator extends LinearLayout{
	 ...
	 * 三角形的宽度为单个Tab的1/6
	 */
	static final float RADIO_TRIANGEL=1.0f/6;
	/**
	 * 三角形最大的宽度
	 */
	final int DIMENSION_TRIANGEL_WIDTH=(int) (getScreenWidth() / 3 * RADIO_TRIANGEL);
	/**
	 * 初始时，三角形指示器的偏移量
	 */
	 ...
	 * 默认的tab数量
	 */
	static final int COUNT_DEFAULT_TAB=4;
	/**
	 * tab数量
	 */
	int mTabVisibleCount=COUNT_DEFAULT_TAB;
	/**
	 * tab上的内容
	 */
	 ...
	 * 标题默认颜色
	 */
	static final int COLOR_TEXT_NORMAL=0x77FFFFFF;
	/**
	 * 标题选中时的颜色
	 */
	static final String COLOR_TEXT_HEIGHTCOLOR="#FFFFFF";
	/**
	 * xml文件使用就会调用这个构造方法
	 * @param context
	 * @param attrs
	 ...
	 * @param position
	 */
	void highLightTextView(int position){
		View view=getChildAt(position);
		if (view instanceof TextView) {
//			((TextView) view).setTextColor(COLOR_TEXT_HEIGHTCOLOR);
			((TextView) view).setTextColor(Color.parseColor(COLOR_TEXT_HEIGHTCOLOR));
		}
	}
	/**
	 * 重置文本颜色
